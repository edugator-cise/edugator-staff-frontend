...
export default {
  ...
  runCodeRequest(sourceCode: string, languageId: number, base64: boolean, stdin: string) {
    const payload = {
  ...
  runCodeSubmission(sourceCode: string, languageId: number, base64: boolean, stdin: string, problemId: string) {
    const payload = {
      source_code: sourceCode,
      language_id: languageId,
      base_64: base64,
