        ...
        <TextHolder>
            ...
            <div id="1">
                <Typography variant="body1" sx={{lineHeight: 2}}>
                    ...
                    <br/>
                    <br/>
                    <b>In Short: </b><i>We collect personal information that you provide to us.</i>
                    <br/>
                    <br/>
                    ...
                    <ul>
                        ...
                        All personal information that you provide to us must be true, complete, and accurate, and you must notify us of any changes to such personal information. Our website may link to external sites that are not operated by us. Please be aware that we have no control over the content and practices of these sites, and cannot accept responsibility or liability for their respective privacy policies.
                    <br/><br/>
                </Typography>
            </div>
            <div id="2">
                <Typography variant="body1" sx={{lineHeight: 2}}>
                    ...
                    <br/>
                    <br/>
                    <b>In Short: </b><i>We process your information for purposes based on legitimate business interests, the fulfillment of our contract with you, compliance with our legal obligations, and/or your consent.</i>
                    <br/>
                    <br/>
                    ...
                    <ul>
                        ...
                        <li>
                            <b>Administer prize draws and competitions.</b> We may use your information to administer prize draws and competitions when you elect to participate in our competition.
                        </li>
                        <li>
            ...
            <div id="3">
                <Typography variant="body1" sx={{lineHeight: 2}}>
                    ...
                    <br/>
                    <br/>
                    Edugator is not in the business of selling your information. Edugator does not provide, sell, rent or lease your information to any third parties. In compliance with FERPA, we do not share any personally identifying information or education records publicly or with third-parties, except when required to by law or with the consent of the student or university.
                    <br/>
                    <br/>
                </Typography>
            </div>
            <div id="4">
                <Typography variant="body1" sx={{lineHeight: 2}}>
                    ...
                    <br/>
                    <br/>
                    <b>In Short: </b><i>We keep your information for as long as necessary to fulfill the purposes outlined in this privacy notice unless otherwise required by law.</i>
                    <br/>
                    <br/>
                    We will only keep your personal information for as long as it is necessary for the purposes set out in this privacy notice, unless a longer retention period is required or permitted by law (such as tax, accounting or other legal requirements). No purpose in this notice will require us keeping your code submissions for longer than 7 days.
                    <br/>
                    <br/>
            ...
            <div id="5">
                <Typography variant="body1" sx={{lineHeight: 2}}>
                    ...
                    <br/>
                    <br/>
                    <b>In Short: </b><i>We aim to protect your personal information through a system of organizational and technical security measures.</i>
                    <br/>
                    <br/>
            ...
            <div id="9">
                <Typography variant="body1" sx={{lineHeight: 2}}>
                    ...
                    <br/>
                    <br/>
                    <b>In Short: </b><i>Yes, if you are a resident of California, you are granted specific rights regarding access to your personal information.</i>
                    <br/>
                    <br/>
            ...
            <div id="12">
                <Typography variant="body1" sx={{lineHeight: 2}}>
                    <b>12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?     </b>
                    <br/>
                    <br/>
