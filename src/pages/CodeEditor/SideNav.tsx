...
export const Sidenav = () => {
  ...
  const navStructure = useSelector((state: RootState) => state.codeEditor.navStructure)
  ...
  const handleClick = (item: string) => {
    ...
    return (
      <List
        ...
        subheader={
          <ListSubheader component="div" id="nested-list-subheader" sx={{borderBottom: "1px solid #e2e2e2"}}>
            Exercises
          </ListSubheader>
        }
      >
