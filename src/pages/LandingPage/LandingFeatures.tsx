  ...
  const features = [
    {
      ...
      img: Glasses,
      description: "Edugator is built to make your life easier. Modules, sample problems, documentation, and more!"
    },
    {
      title: "Designed to be modern",
      img: Diamond,
      description: "Designed with the latest design trends in mind. Edugator feels modern, minimal, and beautiful."
    },
    {
      title: "Lessons for everything",
      img: FlipChart,
      description: "We’ve written extensive documentation for what you need to know for COP3530."
    },
  ]
