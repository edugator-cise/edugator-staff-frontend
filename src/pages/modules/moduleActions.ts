...
import {
    IModuleState, IModulesGETEnd, IModulesGETFail,
...
export const getModulesEnd =
    (state: WritableDraft<IModuleState>, action: PayloadAction<IModulesGETEnd>) => {
...
export const getModulesFail =
    (state: WritableDraft<IModuleState>, action: PayloadAction<IModulesGETFail>) => {
        state.isLoading = false;
...
export const addModule =
    (state: WritableDraft<IModuleState>, action: PayloadAction<IModulesPUT>) => {
        state.isLoading = true;
        // TODO: Add to sagas
...
export const addModuleEnd =
    (state: WritableDraft<IModuleState>, action: PayloadAction<IModule>) => {
        state.isLoading = false;
        // TODO: Add to sagas
...
export const addModuleFail =
    (state: WritableDraft<IModuleState>, action: PayloadAction<IModulesPUTFail>) => {
        state.isLoading = false;
        // TODO: Add to sagas
