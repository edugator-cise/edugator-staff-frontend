        ...
        >
          {tabs.map((tab) => (
            <Tabs.Trigger
              key={tab}
              asChild
              className="cursor-pointer after:h-full after:w-full after:absolute after:rounded-md after:scale-75 after:transition hover:after:scale-100 hover:after:bg-slate-300/50 dark:hover:after:bg-slate-300/20 z-0 after:-z-10 px-2 relative rounded-md group py-2 flex-1 text-sm font-dm leading-none text-slate-500 select-none hover:text-slate-700 data-[state=active]:bg-slate-300 data-[state=active]:text-slate-900 dark:hover:text-white dark:data-[state=active]:text-white dark:data-[state=active]:bg-slate-700 outline-none"
              value={tab}
            >
