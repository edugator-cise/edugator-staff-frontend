...
export const CodeEditorForm = ({ formRef }: Props) => {
  ...
  const cpp = languages.find((lang) => lang.language === "C++");
  const py = languages.find((lang) => lang.language === "Python");
              ...
              <AccordionDetails>
                  ...
                  <Box>
                    <FormControl>
                      ...
                      <Select
                        name="fileExtension"
                        value={values.code.find((lang) => lang.language === "C++")?.fileExtension}
                        label="fileExtension"
