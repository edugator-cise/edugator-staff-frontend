...
const MultipleChoiceStudentComponent: React.FC<MultipleChoiceProps> = ({
  ...
  return (
    <NodeViewWrapper
      ...
      className="bg-slate-100 dark:bg-slate-800 ring-1 ring-slate-300 dark:ring-white/10 flex flex-col p-4 pt-6 rounded-md mb-10 mt-16 relative"
    >
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-1 mb-4">
        ...
        <input
          type="text"
          className="content dark:bg-slate-700 dark:text-white bg-white w-full rounded-md p-2 text-slate-800 font-dm text-base outline-none border border-slate-300 dark:border-slate-600"
          value={question}
          onClick={(e) => {
          ...
          >
            {answers.map((answer: string, index: number) => (
              <div key={index} className="flex space-x-2 w-full items-center">
                <div
                  className={`rounded-md w-full bg-white dark:text-white dark:bg-slate-700 flex  items-center space-x-2 text-slate-800 transition font-dm text-base outline-none border px-2 ${
                    index === correctAnswer
                      ? "border-emerald-500"
                ...
                >
                  ...
                  <input
                    ...
                    type="text"
                    className={`w-full text-slate-800 dark:text-white dark:bg-slate-700 p-2 bg-white font-dm text-base outline-none rounded-md`}
                    value={answer}
