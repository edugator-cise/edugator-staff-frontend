...
export const ExpandArrowLight = () => {
  return (
    <div className="relative w-5 h-5 flex items-center justify-center">
      <div className="h-[2px] w-3 bg-white transition ease-in-out scale-x-0 group-hover:scale-x-100 absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2"></div>
      <ChevronRight className="w-5 h-5 text-white transition group-hover:translate-x-[3px] " />
    </div>
  );
};
