  ...
  const topics = [
    {
      ...
      staticImg: SortingStatic.src,
      animatedImg: SortingGif.src,
    },
    {
      name: "Linked Lists",
      description: "Connected data sets in node format",
      staticImg: LinkedStatic.src,
      animatedImg: LinkedGif.src,
    },
    {
      name: "Stacks and Queues",
      description: "An intro about stacks and queues",
      staticImg: StackStatic.src,
      animatedImg: StackGif.src,
    },
    {
      name: "Heaps",
      description: "Fundamentals of min and max heap and priority queue",
      staticImg: HeapStatic.src,
      animatedImg: HeapGif.src,
    },
    {
      name: "Sets and Maps",
      description: "Module on understanding the type of sets and maps",
      staticImg: MapStatic.src,
      animatedImg: MapGif.src,
    },
    {
      name: "Recursion",
      description: "Everything recursive happens recursively",
      staticImg: RecursiveStatic.src,
      animatedImg: RecursiveGif.src,
    },
  ];
