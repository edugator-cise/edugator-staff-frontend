  ...
  return lessonLoading ? (
    <div className="w-full h-full flex flex-col items-center bg-white">
      ...
      <div className="h-full max-w-4xl mt-14 w-[90%] bg-white p-4 flex flex-col items-start space-y-4">
        <div className="rounded-md h-12 w-1/2 bg-slate-300 animate-pulse"></div>

        <div className="rounded-md w-28 h-8 bg-slate-300 animate-pulse !mt-12"></div>
        <div className="rounded-md w-full h-4 bg-slate-300 animate-pulse !mt-6"></div>
        <div className="rounded-md w-full h-4 bg-slate-300 animate-pulse"></div>
        <div className="rounded-md w-96 h-4 bg-slate-300 animate-pulse"></div>
        <div className="rounded-md w-full h-4 bg-white"></div>
        <div className="rounded-md w-full h-48 bg-slate-300 animate-pulse"></div>
        <div className="rounded-md w-full h-4 bg-white"></div>
        <div className="rounded-md w-full h-4 bg-slate-300 animate-pulse"></div>
        <div className="rounded-md w-96 h-4 bg-slate-300 animate-pulse"></div>
