    ...
    <>
      ...
      <div className="leading-7">
        <Typography variant="body1" sx={{ lineHeight: 2 }}>
          ...
          <Link href="#6">6. DO WE COLLECT INFORMATION FROM MINORS?</Link>{" "}
          <br />
          ...
          <Typography variant="body1" sx={{ lineHeight: 2 }}>
            ...
            <ul>
              ...
              <li>
                ...
                elect to participate in our competition.
              </li>
              <li>
                <b>
        ...
        <div id="3">
          <Typography variant="body1" sx={{ lineHeight: 2 }}>
            ...
            personally identifying information or education records publicly or
            with third-parties, except when required to by law or with the
        ...
        <div id="4">
          <Typography variant="body1" sx={{ lineHeight: 2 }}>
            ...
            notice will require us keeping your code submissions for longer than
            7 days.
            <br />
            <br />
        ...
        <div id="5">
          ...
          <div id="12">
            <Typography variant="body1" sx={{ lineHeight: 2 }}>
              ...
              personal information, please submit a request on the above contact
...
PrivacyPolicy.getLayout = function getLayout(page: ReactNode) {
  return <LegalLayout title="Privacy Policy">{page}</LegalLayout>;
};
