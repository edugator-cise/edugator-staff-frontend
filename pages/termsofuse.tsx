  ...
  return (
    <>
      ...
      <div className="leading-7">
        ...
        you, whether personally or on behalf of an entity (“you”) and Edugator
        ...
        information or education records publicly or with third parties, except
        when required to by law or with the consent of the student or
        university. The Site is intended for users who are at least 18 years of
        age.
        <br />
        <br />
        ...
        in USA, Florida. Except as otherwise provided herein, the Parties may
        ...
        courts located in USA, Florida, and the Parties hereby consent to, and
...
TermsOfUse.getLayout = function getLayout(page: ReactNode) {
  return <LegalLayout title="Terms of Use">{page}</LegalLayout>;
};
